...
const _en = {
  ...
  pricing: {
    ...
    hero: {
      ...
      subtitle:
        'We publish our commission structure, our subscription price, and what\u2019s included — so parents, athletes, brands, and compliance officers can read this page, decide, and sign up in minutes.',
    },
    tiers: {
      mostPopular: 'Most popular for brands',
      athletesName: 'Athletes',
      athletesHeadline: 'Free to join',
      athletesPrice: '$0',
      ...
      athletesFeature2: '15% commission — only on deals StatStaq’s deal desk sources and closes',
      athletesFeature3: '0% on deals you bring yourself — those stay entirely yours',
      athletesFeature4: 'You keep 85% of StatStaq-sourced deals, 100% of deals you bring',
      ...
      brandsFeature2: 'No per-deal platform fee',
      ...
      brandPlusFeature5: 'No per-deal platform fee — same as Brands',
    ...
    finalCta: {
      ...
      disclaimer:
        'We do not charge application fees. We do not charge athletes. Parents never see a fee. Our 15% commission on StatStaq-sourced deals pays for platform + compliance + state-disclosure infrastructure.',
    },
  },

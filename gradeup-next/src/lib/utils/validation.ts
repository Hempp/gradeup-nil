...
// Note: DOMPurify sanitization functions have been moved to './sanitize.ts'
// to reduce bundle size. Import from there if you need sanitizeText or sanitizeHtml.
...
// NOTE: Sanitization functions (sanitizeText, sanitizeHtml) have been moved to '@/lib/utils/sanitize'
// to reduce bundle size since they require DOMPurify (~13KB).
// Import directly from '@/lib/utils/sanitize' instead of here.

...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'No. Local brands — restaurants, tutors, training facilities, small retail — care more about your GPA, sport, and community fit than your follower count. GradeUp verifies your GPA so you’re findable; StatStaq’s team does the outreach and matching in your state, not the brands chasing D1 quarterbacks.',
  },
  {
    question: 'How does GPA verification work?',
    answer:
      'You start self-reported. Upload a transcript and our OCR review can auto-approve you on the spot — if it reads at least 90% confidence and your extracted GPA is within 0.05 of what you claimed. Your school can also confirm your GPA directly, which is the strongest tier. Brands filter by verified GPA because it’s a trust signal, and a verified badge is what puts you in front of StatStaq’s deal-sourcing team.',
  },
  {
    question: 'What does “share-the-win” mean?',
    answer:
      'When a deal closes, StatStaq’s team turns it into an auto-generated trajectory card — your school, your sport, your verified GPA, and the deal. Share it to Instagram, TikTok, X, or LinkedIn with one tap. We track the share as verified social proof, which StatStaq uses to source your next deal.',
  },
  {
    question: 'Can I sign if I’m a minor?',
    answer:
      'Yes. Most pilot states allow it with a parent or legal guardian’s consent, which GradeUp collects and stores on every deal. Texas requires you to be at least 17; payment is held in trust until your 18th birthday (we handle that automatically). GradeUp handles the compliance rails; StatStaq handles the deal itself.',
  },
  {
    question: 'Will this hurt my future NCAA eligibility?',
    answer:
      'No. GradeUp follows your state’s high-school athletic association rules, and StatStaq never negotiates anything that would jeopardize eligibility — school IP, pay-for-play, or banned categories. Your future college coach will see a clean history.',
  },
  {
    question: 'How fast do I get paid?',
    answer:
      'Depends on the deal. Typical flow: the brand funds escrow at signing, StatStaq reviews your deliverable within 48 hours of submission, and payout releases as soon as it’s approved. There’s no guaranteed timeline to your first deal — but StatStaq’s team is the one running the search and the negotiation, not you.',
  },
];
  ...
  return (
    <>
      <SolutionSchema
        ...
        description="GradeUp verifies your GPA in three tiers, from self-reported to institution-verified. Once you qualify, StatStaq’s team produces your content, values your brand, sources your deals, and negotiates your contracts."
      ...
      <SolutionHero
        ...
        subtitle="Verify your GPA, and StatStaq’s team takes over: they produce your content, value your brand, source your deals, and negotiate your contracts. Parental consent gets handled in the background. You focus on the sport and the studying."
        primaryCta={{
      ...
      <ProblemProductProof
        eyebrow="The athlete’s problem"
        heading="You’re doing the work. The old game rewards the wrong things."
        ...
        steps={[
          {
            ...
            body: 'If you’re a sophomore with a 3.8 and 800 followers, most NIL platforms don’t have a place for you. Brands can’t filter by grade; your profile gets buried; deals ghost after the first message.',
            bullets: [
          ...
          },
          {
            ...
            body: 'A verified-GPA badge, in three tiers, front and center. A deal feed StatStaq curates by your state and sport. Content StatStaq produces after every deal. Parental consent collected once and reused every time. It’s a profile that compounds — and a team that runs it.',
            bullets: [
              '3-tier verified GPA badge brands can actually filter for',
              'StatStaq-produced share cards after every deal',
              'Deal feed tailored to your state’s rules',
          ...
          },
          {
            ...
            body: 'StatStaq’s team is already producing, valuing, sourcing, and negotiating for verified athletes. Every closed deal becomes a case study — tied to a verified GPA, a real school, and an on-platform share — published as it happens, not projected.',
            bullets: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <FeatureCard
              ...
              body="StatStaq’s team turns every closed deal into content — the trajectory card, the caption, the deliverable brief. You show up; they handle production. Share it in one tap."
            />
            <FeatureCard
              icon={<TrendingUp className="h-6 w-6" />}
              title="StatStaq values your brand"
              body="Your GPA, sport, grade level, and closed deals build a public trajectory that shows exactly what you’re worth — a valuation StatStaq’s team uses to price your next deal."
            />
            <FeatureCard
              icon={<Trophy className="h-6 w-6" />}
              title="StatStaq sources your deals"
              body="Local brands in your state looking for your sport, your grade level, your fit — StatStaq’s team finds them and brings the deal to you. No cold outreach, no guessing."
            />
            <FeatureCard
              icon={<Users className="h-6 w-6" />}
              title="StatStaq negotiates your contracts"
              body="You don’t set the price or read the fine print alone. StatStaq’s team negotiates terms, deliverables, and pay on your behalf, and GradeUp keeps parental consent on file for every deal."
            />
            <FeatureCard
              icon={<Rocket className="h-6 w-6" />}
              title="Bridge to college"
              body="Your HS profile carries forward. When you commit, the trajectory doesn’t reset — you walk onto campus already qualified, with StatStaq’s team representing you from day one."
            />
          </div>
        </div>
      </section>
      ...
      <TestimonialQuote
        quote="I didn’t think my grades mattered for NIL. That was the whole pitch of the old platforms — just get followers. GradeUp verified my 3.9, and StatStaq’s team found the brand, wrote the contract, and got it signed. My first deal paid more than my summer job."
      ...
      <SolutionFaq
        ...
        pageUrl={PAGE_URL}
        heading="Stuff you’re actually wondering"
      ...
      <SolutionCtaBand
        ...
        secondaryLabel="See what you’re worth"

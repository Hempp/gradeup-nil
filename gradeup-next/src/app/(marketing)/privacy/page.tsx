  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-[var(--ink)] mb-8">Privacy Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">Information We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">How We Use Your Information</h2>
            <p className="text-[var(--ink-muted)] mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">Data Security</h2>

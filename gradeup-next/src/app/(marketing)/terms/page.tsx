  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-[var(--ink)] mb-8">Terms of Service</h1>

        <div className="prose prose-lg max-w-none">
          <p className="text-[var(--ink-muted)] text-lg mb-6">
            Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
          </p>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">Acceptance of Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">NCAA Compliance</h2>
            <p className="text-[var(--ink-muted)] mb-4">
              GradeUp NIL is committed to maintaining NCAA compliance. Users agree to:
            </p>
            <ul className="list-disc pl-6 text-[var(--ink-muted)] space-y-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">User Responsibilities</h2>
            <p className="text-[var(--ink-muted)] mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">Platform Fees</h2>
            <p className="text-[var(--ink-muted)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">Limitation of Liability</h2>
            <p className="text-[var(--ink-muted)]">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-[var(--ink)] mb-4">Contact Us</h2>
            <p className="text-[var(--ink-muted)]">

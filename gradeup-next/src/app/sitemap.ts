...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${origin}/solutions`, lastModified: now, changeFrequency: 'weekly', priority: 0.7 },
    ...
    { url: `${origin}/solutions/brands/fitness`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${origin}/solutions/brands/fmv`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${origin}/solutions/brands/local-restaurant`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${origin}/solutions/brands/local-retail`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${origin}/solutions/brands/templates`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${origin}/solutions/brands/training-facility`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },
    { url: `${origin}/solutions/brands/tutoring`, lastModified: now, changeFrequency: 'monthly', priority: 0.6 },

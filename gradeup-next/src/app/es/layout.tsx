...
export default function SpanishMarketingLayout({
  ...
  return (
    <div className="marketing-dark min-h-screen" lang="es">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[var(--accent-primary)] focus:text-[var(--text-inverse)] focus:rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--accent-primary)]"
      >

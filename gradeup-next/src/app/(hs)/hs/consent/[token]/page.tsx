...
export default async function ConsentSigningPage({ params }: PageProps) {
  ...
  const { scope, parentEmail, parentFullName, expiresAt } = result;
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        <header>
          ...
          <p className="mt-4 text-white/70">
            Your athlete has asked for your permission to participate in NIL deals on GradeUp.
            Federal and state law require a parent or legal guardian to consent before any deal
            can be signed. Please review the terms below carefully — this is a legal document.
          </p>
        </header>
        ...
        <section className="mt-10">
          ...
          <p className="mt-2 text-sm text-white/60">
            By signing below you confirm you are the parent or legal guardian named above and
            that you agree to the scope described.
          </p>
          <div className="mt-6">
            <ConsentSignForm
              token={token}

...
// Mock conversations (similar to athlete but from brand perspective)
const mockConversations = [
  {
    id: '1',
    athlete: { name: 'Marcus Johnson', school: 'Duke University' },
  ...
  {
    id: '2',
    athlete: { name: 'Sarah Williams', school: 'Stanford University' },
    dealTitle: 'Social Media Partnership',
    lastMessage: "I've reviewed the offer. Can we discuss the deliverables?",
    lastMessageAt: '2024-02-10T16:45:00Z',
    unreadCount: 2,
  },
  {
    id: '3',
    athlete: { name: 'Jordan Davis', school: 'Ohio State' },
    dealTitle: 'Store Appearance',
    lastMessage: 'What time should I arrive for the event?',
...
const mockMessages = [
  {
    id: '1',
    senderId: 'brand',
    message: 'Hi Marcus! We loved your recent posts and would like to discuss a partnership.',
    createdAt: '2024-02-10T09:00:00Z',
  },
  {
    id: '2',
    senderId: 'athlete',
    message: 'Thank you! I\'m very interested in working with Nike.',
    createdAt: '2024-02-10T09:15:00Z',
  },
  {
    id: '3',
    senderId: 'brand',
    message: 'Great! We\'re looking for content featuring our new running shoes line.',
    createdAt: '2024-02-10T09:30:00Z',
  },
  {
    id: '4',
    senderId: 'athlete',
    message: 'That sounds perfect. I can showcase them during my training sessions.',
        ...
        {conversations.map((conv) => (
          ...
          >
            <div className="flex items-start gap-3">
              <Avatar fallback={conv.athlete.name.charAt(0)} size="md" />
    ...
    <div className="flex-1 flex flex-col">
      <div className="h-16 px-4 flex items-center justify-between border-b border-[var(--border-color)]">
        <div className="flex items-center gap-3">
          <Avatar fallback={conversation.athlete.name.charAt(0)} size="md" />
          <div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((msg) => (
          <div
            key={msg.id}
            className={`flex ${msg.senderId === 'brand' ? 'justify-end' : 'justify-start'}`}
          >
            <div
            ...
            >
              ...
              <p
                className={`text-xs mt-1 ${
                  msg.senderId === 'brand' ? 'text-white/60' : 'text-[var(--text-muted)]'
                }`}
              >
